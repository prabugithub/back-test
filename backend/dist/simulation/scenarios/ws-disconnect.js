...
(0, scenarioRunner_1.registerScenario)({
    ...
    setup() {
        ...
        setTimeout(() => (0, mockMarketFeed_1.simulateDisconnect)(), 3500);
        setTimeout(() => (0, mockMarketFeed_1.simulateReconnect)(), 12000);
    },
    ticks: [
    ...
    teardown() {
        (0, mockMarketFeed_1.simulateReconnect)(); // ensure we always end connected
    },
});
